    ...
    public function run(): void
    {
        ...
        $organisasis = [
            ...
            [
                ...
                'nama' => 'Sukirno',
                'jabatan' => 'Ketua',
                'photo' => 'organisasi_photos/b1.png',
            ],
            [
                'instansi_id' => 5,
                'nama' => 'Heriyanto',
                'jabatan' => 'Wakil Ketua',
                'photo' => 'organisasi_photos/b2.png',
            ],
            [
                'instansi_id' => 5,
                'nama' => 'Catur Purnami',
                'jabatan' => 'Sekretaris',
                'photo' => 'organisasi_photos/b3.png',
            ],
            [
                'instansi_id' => 5,
                'nama' => 'Kumpul Adi Guyub',
                'jabatan' => 'Anggota',
                'photo' => 'organisasi_photos/b4.png',
            ],
            [
                'instansi_id' => 5,
                'nama' => 'Mustam',
                'jabatan' => 'Anggota',
                'photo' => 'organisasi_photos/b5.png',
            ],
            [
                'instansi_id' => 5,
                'nama' => 'Siswanto',
                'jabatan' => 'Anggota',
                'photo' => 'organisasi_photos/b6.png',
            ],
            [
                'instansi_id' => 5,
                'nama' => 'Reka Wulandari',
                'jabatan' => 'Anggota',
                'photo' => 'organisasi_photos/b7.png',
            ],
            [
                'instansi_id' => 6,
                'nama' => 'Sigit Widianto',
