    ...
    <div class="about-container">
        ...
        <div class="section">
            <div class="section-content">
                ...
                <p>
                    Desa Sumber Urip memiliki potensi sumber daya alam yang melimpah dan beragam. Wilayahnya yang terdiri dari lahan pertanian subur, kawasan perbukitan, serta hutan konservasi menjadikan desa ini kaya akan kekayaan alam yang dapat dimanfaatkan untuk mendukung kehidupan masyarakat, pertumbuhan ekonomi, dan pengembangan pariwisata berkelanjutan. Potensi ini tersebar di berbagai sektor seperti pertanian, wisata alam, sumber air panas, hingga konservasi lingkungan.
                </p>
                <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item rounded d-flex h-100">
                        ...
                        <div class="service-text rounded p-5">
                            ...
                            <p class="mb-4">Mayoritas lahan desa digunakan untuk pertanian sayur-mayur seperti kol, cabai, tomat, dan kentang. Sistem pertanian masih banyak yang tradisional namun sangat potensial untuk dikembangkan secara modern dan berkelanjutan.</p>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item rounded d-flex h-100">
                        ...
                        <div class="service-text rounded p-5">
                            ...
                            <p class="mb-4">Bukit Kaba adalah kawasan perbukitan dan gunung berapi aktif yang menjadi ikon wisata alam.</p>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item rounded d-flex h-100">
                        ...
                        <div class="service-text rounded p-5">
                            ...
                            <p class="mb-4">Sumber air panas alami yang berada di wilayah desa menjadi tempat relaksasi dan terapi tradisional bagi warga. Tempat ini memiliki potensi besar untuk dikembangkan sebagai wisata kesehatan berbasis alam.</p>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item rounded d-flex h-100">
                        ...
                        <div class="service-text rounded p-5">
                            ...
                            <p class="mb-4">Sebagian wilayah desa berada dekat dengan kawasan hutan wisata dan konservasi, yang mendukung ekosistem alami dan dapat dijadikan tempat edukasi lingkungan dan penelitian.</p>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item rounded d-flex h-100">
                        ...
                        <div class="service-text rounded p-5">
                            ...
                            <p class="mb-4">Terdapat sistem irigasi sederhana dan saluran drainase yang menopang aktivitas pertanian, meskipun masih perlu pengembangan lebih lanjut agar lebih efisien.</p>
